...
class PopUpT(object):
    def __init__(self, cell_size, master):
        ...
        tk.Label(self.top, text=msg0 + msg1).grid(sticky=tk.EW, row=0, column=0, columnspan=2, pady=cfg.yd)
        tk.Label(self.top, text="Cell size (in METERS):").grid(sticky=tk.W, row=1, column=0, pady=cfg.yd)
        ...
        self.h = tk.StringVar()
        self.h.set(3.0)
        tk.Label(self.top, text="Estimated water depth (in METERS):").grid(sticky=tk.W, row=2, column=0, pady=cfg.yd)
        self.e_h = tk.Entry(self.top, width=30, textvariable=self.h)
        self.e_h.grid(sticky=tk.W, row=2, column=1, pady=cfg.yd)
        ...
        b_calc.grid(sticky=tk.EW, row=3, column=0, columnspan=2, padx=cfg.xd, pady=cfg.yd)
        self.l_ts = tk.Label(self.top, text="Estimated minimum timestep: ")
        self.l_ts.grid(sticky=tk.W, row=4, column=0, columnspan=2, pady=cfg.yd)
        ...
        b_calc.grid(sticky=tk.EW, row=5, column=0, columnspan=2, padx=cfg.xd, pady=cfg.yd)
